...
// $rt_nm = $_SESSION["res_nm"];

if (isset(($_POST['rt_nm']))) {
	# code...
...
{
// 	$hid=$_POST['hidden_nm'];
// 	$query="INSERT INTO temp_cart (food_id) VALUES('$hid')";
...
// }
                            ...
                            $query=mysqli_query($conn,"SELECT food_name,price FROM food WHERE restaurant_name='$rt_nm'  ")  ;
...
<input type="hidden" name="hidden_nm" value="<?php echo $name;?>">
<input type="hidden" name="hidden_pr" value="<?php echo $price;?>">
                           ...
                           <div class="food-item white">
                              <div class="row">
                                 ...
                                 <!-- end:col -->
                                 <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left"><?php echo "".$price ?></span> <button class="btn btn-small btn btn-secondary pull-right" type="submit" name="sub">&#43;</button> </div>
                              </div>
                              <!-- end:row -->
                           </div>
                           </form>
