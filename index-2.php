    ...
    <section class="hero bg-image" data-image-src="images/wall.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <h5 class="font-white space-xs">Find the best restaurants, cafés, and bars</h5>
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-3 add-title">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-4 join-btn text-xs-right"><a href="submition.php" class="btn theme-btn btn-lg">I‘m restaurant</a> </div>
                                                                </div>
                                                            </div>
                                                        </section>
                                                        <!-- add restaurant ends -->
